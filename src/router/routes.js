const routes = [
  {
    ...
    children: [
      ...
      { path: 'quick-posts/new', component: () => import('@/pages/QuickPostEditPage.vue'), meta: { requiresWriter: true } },
      { path: 'quick-posts/:id/edit', component: () => import('@/pages/QuickPostEditPage.vue'), meta: { requiresWriter: true } },
      { path: 'quick-posts', component: () => import('@/pages/QuickPostsPage.vue'), meta: { requiresWriter: true } },
